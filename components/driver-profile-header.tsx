            ...
            <div className="relative">
              {driver.photo ? (
                <>
                  ...
                  <div
                    className="w-[150px] h-[150px] rounded-lg bg-muted flex items-center justify-center text-4xl font-semibold text-muted-foreground"
                    style={{ display: "none" }}
                  >
                    {driver.name
                      .split(" ")
                ...
                <div className="w-[150px] h-[150px] rounded-lg bg-muted flex items-center justify-center text-4xl font-semibold text-muted-foreground">
                  {driver.name
                    .split(" ")
                    .map((n) => n[0])
                    .join("")
